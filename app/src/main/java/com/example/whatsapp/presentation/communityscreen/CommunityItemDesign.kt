...
fun CommunityItemDesign( communities: Communities) {
    ...
    Row(
        ...
        Column() {
            ...
            Text(communities.communityName, fontSize = 16.sp, fontWeight = FontWeight.Bold)

            Text(communities.communitymembers, fontSize = 14.sp, color = Color.Gray)
        }
